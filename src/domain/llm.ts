...
export const PROVIDER_METADATA: Readonly<Record<ProviderId, LlmProviderMeta>> = Object.freeze({
  ...
  glm: {
    ...
    group: "domestic",
    label: "智谱 GLM",
    models: ["glm-5.3", "glm-5.3-flash", "glm-5.2", "glm-4.7-flash", "glm-4.6", "glm-4.6v-flash", "glm-4v-flash"],
  ...
  openai: {
    ...
    group: "international",
    label: "OpenAI (GPT)",
    models: ["gpt-6-luna", "gpt-6-sol", "gpt-6-astra", "gpt-5.6-luna", "gpt-5.6-sol", "gpt-5.6-terra", "gpt-5.5", "gpt-4.1", "gpt-4.1-mini"],
  ...
  claude: {
    ...
    models: ["claude-sonnet-5", "claude-opus-5-5", "claude-fable-5-1", "claude-opus-5", "claude-fable-5", "claude-haiku-4-5"],
    defaultModel: "claude-sonnet-5",
    supportsImage: true,
    imageModels: ["claude-sonnet-5", "claude-opus-5-5", "claude-fable-5-1", "claude-opus-5", "claude-fable-5", "claude-haiku-4-5"],
